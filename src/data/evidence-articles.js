...
export const evidenceArticles = [
  {
    ...
    readTime: 15,
    title: { 
      ro: 'Cele 6 principii ale teratologiei (Wilson, 1973)', 
      en: 'The 6 Principles of Teratology (Wilson, 1973)' 
    },
    subtitle: { 
      ro: 'Fundamentul științific al evaluării riscului teratogen', 
      en: 'Scientific foundation for teratogenic risk assessment' 
    },
    summary: { 
      ro: 'Principiile lui Wilson definesc modul în care agenții teratogeni afectează dezvoltarea fetală.', 
      en: 'Wilson\'s principles define how teratogenic agents affect fetal development.' 
    },
    content: { 
      ro: `# Cele 6 Principii ale Teratologiei (Wilson, 1973)
